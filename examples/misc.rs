...
use ncollide::narrow_phase::{ContactDispatcher, DefaultContactDispatcher, PlaneSupportMapContactGenerator,
                             IncrementalContactManifoldGenerator, OneShotContactManifoldGenerator};


fn main() {
    let dispatcher: DefaultContactDispatcher<Point3<f64>, Isometry3<f64>> = DefaultContactDispatcher::new();
