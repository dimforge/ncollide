...
#[inline]
pub fn point_cloud_bounding_sphere_with_center<V: FloatVec<N>, N: Float>(pts: &[V], center: V) -> (V, N) {
...
// FIXME: return a bounding sphere?
#[inline]
pub fn point_cloud_bounding_sphere<V: FloatVec<N>, N: Float + Cast<f64>>(pts: &[V]) -> (V, N) {
