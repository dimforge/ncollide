 ...
 */
#[cfg(feature = "dim3")]
pub fn cuboid<N: Real>(extents: &Vector<N>) -> TriMesh<N> {
 ...
 */
#[cfg(feature = "dim3")]
pub fn unit_cuboid<N: Real>() -> TriMesh<N> {
...
#[cfg(feature = "dim2")]
pub fn rectangle<N: Real>(extents: &Vector<N>) -> Polyline<N> {
...
#[cfg(feature = "dim2")]
pub fn unit_rectangle<N: Real>() -> Polyline<N> {
    let _0_5: N = na::convert(0.5);
    let m0_5: N = -_0_5;
