...
/// Trait of objects that can be tested for point iclusion and projection.
...
/// Trait of objects that can be transformed and tested for point iclusion and projection.
