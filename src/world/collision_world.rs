...
use world::{CollisionObjectsDispatcher, CollisionObject, AbstractCollisionDetector, CollisionGroups};
...
impl<N, P, V, AV, M, T> CollisionWorld<N, P, V, M, T>
    ...
    #[inline(always)]
    pub fn contact_pairs(&self, f: |&T, &T, &AbstractCollisionDetector<N, P, V, M>| -> ()) {
