...
macro_rules! apply_with_mixed_args(
    ($mname: ident,
     ...
     $arg0_shape_against_concave: ident $(, $args_shape_against_concave: ident)*
       ...
       $mname!($arg0_concave_against_shape $(, $args_concave_against_shape)* | Compound<N, P, V, M, I>, Ball<N>)
       $mname!($arg0_concave_against_shape $(, $args_concave_against_shape)* | Compound<N, P, V, M, I>, Cuboid<V>)
       $mname!($arg0_concave_against_shape $(, $args_concave_against_shape)* | Compound<N, P, V, M, I>, Capsule<N>)
       $mname!($arg0_concave_against_shape $(, $args_concave_against_shape)* | Compound<N, P, V, M, I>, Cone<N>)
       $mname!($arg0_concave_against_shape $(, $args_concave_against_shape)* | Compound<N, P, V, M, I>, Cylinder<N>)
       $mname!($arg0_concave_against_shape $(, $args_concave_against_shape)* | Compound<N, P, V, M, I>, Convex<P>)
       $mname!($arg0_concave_against_shape $(, $args_concave_against_shape)* | Compound<N, P, V, M, I>, Segment<P>)
       $mname!($arg0_concave_against_shape $(, $args_concave_against_shape)* | Compound<N, P, V, M, I>, Triangle<P>)
       $mname!($arg0_concave_against_shape $(, $args_concave_against_shape)* | Compound<N, P, V, M, I>, Plane<V>)

       $mname!($arg0_concave_against_shape $(, $args_concave_against_shape)* | Compound<N, P, V, M, I>, Compound<N, P, V, M, I>)
       $mname!($arg0_concave_against_shape $(, $args_concave_against_shape)* | Compound<N, P, V, M, I>, Mesh<N, P, V, Segment<P>>)
       $mname!($arg0_concave_against_shape $(, $args_concave_against_shape)* | Compound<N, P, V, M, I>, Mesh<N, P, V, Triangle<P>>)
       ...
       $mname!($arg0_shape_against_concave $(, $args_shape_against_concave)* | Ball<N>, Compound<N, P, V, M, I>)
       $mname!($arg0_shape_against_concave $(, $args_shape_against_concave)* | Cuboid<V>, Compound<N, P, V, M, I>)
       $mname!($arg0_shape_against_concave $(, $args_shape_against_concave)* | Capsule<N>, Compound<N, P, V, M, I>)
       $mname!($arg0_shape_against_concave $(, $args_shape_against_concave)* | Cone<N>, Compound<N, P, V, M, I>)
       $mname!($arg0_shape_against_concave $(, $args_shape_against_concave)* | Cylinder<N>, Compound<N, P, V, M, I>)
       $mname!($arg0_shape_against_concave $(, $args_shape_against_concave)* | Convex<P>, Compound<N, P, V, M, I>)
       $mname!($arg0_shape_against_concave $(, $args_shape_against_concave)* | Segment<P>, Compound<N, P, V, M, I>)
       $mname!($arg0_shape_against_concave $(, $args_shape_against_concave)* | Triangle<P>, Compound<N, P, V, M, I>)
       $mname!($arg0_shape_against_concave $(, $args_shape_against_concave)* | Plane<V>, Compound<N, P, V, M, I>)

       $mname!($arg0_shape_against_concave $(, $args_shape_against_concave)* | Mesh<N, P, V, Segment<P>>, Compound<N, P, V, M, I>)
       $mname!($arg0_shape_against_concave $(, $args_shape_against_concave)* | Mesh<N, P, V, Triangle<P>>, Compound<N, P, V, M, I>)
       // $mname!($arg0 $(, $args)* | Compound<N, P, V, M, I>, Compound<N, P, V, M, I>)
    }
)
    ...
    ($mname: ident, $arg0: ident $(, $args: ident)*) => {
        {
            ...
            $mname!($arg0 $(, $args)* | Compound<N, P, V, M, I>, Ball<N>)
            $mname!($arg0 $(, $args)* | Compound<N, P, V, M, I>, Cuboid<V>)
            $mname!($arg0 $(, $args)* | Compound<N, P, V, M, I>, Capsule<N>)
            $mname!($arg0 $(, $args)* | Compound<N, P, V, M, I>, Cone<N>)
            $mname!($arg0 $(, $args)* | Compound<N, P, V, M, I>, Cylinder<N>)
            $mname!($arg0 $(, $args)* | Compound<N, P, V, M, I>, Convex<P>)
            $mname!($arg0 $(, $args)* | Compound<N, P, V, M, I>, Segment<P>)
            $mname!($arg0 $(, $args)* | Compound<N, P, V, M, I>, Triangle<P>)
            $mname!($arg0 $(, $args)* | Compound<N, P, V, M, I>, Plane<V>)

            $mname!($arg0 $(, $args)* | Compound<N, P, V, M, I>, Compound<N, P, V, M, I>)
            $mname!($arg0 $(, $args)* | Compound<N, P, V, M, I>, Mesh<N, P, V, Segment<P>>)
            $mname!($arg0 $(, $args)* | Compound<N, P, V, M, I>, Mesh<N, P, V, Triangle<P>>)
            ...
            $mname!($arg0 $(, $args)* | Ball<N>, Compound<N, P, V, M, I>)
            $mname!($arg0 $(, $args)* | Cuboid<V>, Compound<N, P, V, M, I>)
            $mname!($arg0 $(, $args)* | Capsule<N>, Compound<N, P, V, M, I>)
            $mname!($arg0 $(, $args)* | Cone<N>, Compound<N, P, V, M, I>)
            $mname!($arg0 $(, $args)* | Cylinder<N>, Compound<N, P, V, M, I>)
            $mname!($arg0 $(, $args)* | Convex<P>, Compound<N, P, V, M, I>)
            $mname!($arg0 $(, $args)* | Segment<P>, Compound<N, P, V, M, I>)
            $mname!($arg0 $(, $args)* | Triangle<P>, Compound<N, P, V, M, I>)
            $mname!($arg0 $(, $args)* | Plane<V>, Compound<N, P, V, M, I>)

            // $mname!($arg0 $(, $args)* | Compound<N, P, V, M, I>, Compound<N, P, V, M, I>)
            $mname!($arg0 $(, $args)* | Mesh<N, P, V, Segment<P>>, Compound<N, P, V, M, I>)
            $mname!($arg0 $(, $args)* | Mesh<N, P, V, Triangle<P>>, Compound<N, P, V, M, I>)
        }
    }
)
