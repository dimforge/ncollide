...
pub use self::convex_polygons_intersection::{
    convex_polygons_intersection, convex_polygons_intersection_points, PolylinePointLocation,
};
...
pub use self::segments_intersection::{segments_intersection, SegmentsIntersection};
...
pub use self::triangle::{
    circumcircle, is_point_in_triangle, triangle_area, triangle_center, triangle_orientation,
    triangle_perimeter, TriangleOrientation,
};
