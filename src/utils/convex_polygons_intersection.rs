...
pub fn convex_polygons_intersection<N: Real>(
    ...
    while (aa < n || ba < m) && aa < 2 * n && ba < 2 * m {
        ...
        // println!("aHB: {}, {}, {}", poly2[b1], poly2[b2], poly1[a2]);
        // println!("bHA: {}, {}, {}", poly1[a1], poly1[a2], poly2[b2]);
        // println!("Orientations: {:?}, {:?}", aHB, bHA);
            ...
            utils::segments_intersection(&poly1[a1], &poly1[a2], &poly2[b1], &poly2[b2])
        {
            match inter {
                SegmentsIntersection::Point { loc1, loc2 } => {
                    // println!(
                    //     ">>>>>  Found intersection point between ({}, {}), ({}, {}).",
                    //     a1, a2, b1, b2
                    // );
                ...
                SegmentsIntersection::Segment {
                    ...
                    // println!(
                    //     ">>>>>  Found intersection segment between ({}, {}), ({}, {}).",
                    //     a1, a2, b1, b2
                    // );
